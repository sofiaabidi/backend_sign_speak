        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-8 pt-4">
              <div>
                <div className="text-gray-900 text-2xl">50K+</div>
                <div className="text-gray-500 text-sm">Active Learners</div>
              </div>
              <div>
                <div className="text-gray-900 text-2xl">95%</div>
                <div className="text-gray-500 text-sm">Accuracy Rate</div>
              </div>
              <div>
                <div className="text-gray-900 text-2xl">24/7</div>
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md rounded-xl p-4 shadow-lg">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-900 text-sm">Camera Active</span>
                  </div>
                  <div className="text-right">
                    <div className="text-gray-900 text-sm">Gesture Detected</div>
                    <div className="text-blue-600 text-xs">HELLO</div>
                  </div>
                </div>
              </div>
            </div>
