  ...
  const courseData = {
    basics: {
      ...
      lessons: [
        ...
        { id: 3, title: 'Basic Gestures', duration: '6 min', completed: false },
        { id: 4, title: 'Greetings', duration: '6 min', completed: false },
      ]
    },
    alphabet: {
      title: 'Alphabet',
    ...
    commonWords: {
      ...
      lessons: [
        { id: 1, title: 'Introduction', duration: '5 min', completed: true },
        { id: 2, title: 'Family Words', duration: '8 min', completed: true },
        { id: 3, title: 'Food & Drink', duration: '6 min', completed: false },
      ]
    },
    phrases: {
      title: 'Phrases',
      lessons: [
        { id: 1, title: 'Introduction', duration: '5 min', completed: true },
        { id: 2, title: 'Greetings', duration: '8 min', completed: true },
        { id: 3, title: 'Questions', duration: '6 min', completed: false },
      ]
    },
    conversational: {
      ...
      lessons: [
        { id: 1, title: 'Introduction', duration: '5 min', completed: true },
        { id: 2, title: 'Daily Conversations', duration: '8 min', completed: true },
        { id: 3, title: 'Advanced Topics', duration: '6 min', completed: false },
      ]
    }
  };
